...
public class BenchmarkTemplateController {
  ...
  public String z0(@RequestBody String input) {
    return restTemplate.postForObject("http://migrator-provider/benchmark/delay/z0", input, String.class);
  }

  @PostMapping("/delay/z1")
  public String z1(@RequestBody String input) {
    return restTemplate.postForObject("http://migrator-provider/benchmark/delay/z1", input, String.class);
  }

  @PostMapping("/delay/z10")
  public String z10(@RequestBody String input) {
    return restTemplate.postForObject("http://migrator-provider/benchmark/delay/z10", input, String.class);
  }

  @PostMapping("/delay/z100")
  public String z100(@RequestBody String input) {
    return restTemplate.postForObject("http://migrator-provider/benchmark/delay/z100", input, String.class);
  }
}
